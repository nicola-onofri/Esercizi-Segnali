...
for i = 1:length(Tc_arr)
  ...
  subplot(1,2,1); stem(t, xc, 'r', 'Linewidth', 1.5, 'marker', 'none'); title('Sampling','Interpreter','latex','FontSize',10);
  subplot(1,2,2); plot(f, abs(XC), 'r', 'Linewidth', 1.5); title('FT','Interpreter','latex','FontSize',10);
end
